...
export interface InterfaceSubmitFormAddState extends Omit<InterfaceFormAddNewState, 'account_avatar'> {
  account_avatar?: Maybe<string | File | null | undefined>;
}

export interface InterfaceSubmitFormEditState extends Omit<InterfaceFormEditState, 'account_role' | 'account_avatar'> {
  account_role?: Maybe<Blob[] | undefined>;

  account_avatar?: Maybe<string | File | null | undefined>;
}

export interface InterfaceFormAccountDetail extends Omit<InterfaceFormEditState, 'account_avatar' | 'account_role'> {
  account_avatar?: Maybe<string | File | null | undefined>;
