...
import ModalShipperListForAssign from './ModalShipperListForAssign';
import EmployeePaginationOrderList from './EmployeePaginationOrderList';
import EmployeeSearchOrderForm from './EmployeeSearchOrderForm';
...
const EmployeeOrder: React.FC = () => {
  ...
  const [openAssignShipperPopup, setOpenAssignShipperPopup] = useState(false);
  ...
  const handleOpenAssignShipperPopup = ({
    orderId,
    orderCode,
  }: {
    ...
    setOpenAssignShipperPopup(true);
  ...
  //   if (orderId) {
  //     OrderApiService.getOrderItemDetail_ForEmployee({ orderId })
  //       .then((data) => {
  ...
  const handleCloseAssignShipperPopup = () => {
    setOpenAssignShipperPopup(false);
  };
  ...
  const handleGetOrderList = () => {
    OrderApiService.getAllOrderList_ForEmployee(searchParams)
      .then((data) => {
  ...
  return (
    <>
      <Box sx={{ padding: 3 }}>
        ...
        <EmployeeSearchOrderForm onSearch={handleSearchOrder} />
                      ...
                      <TableCell>
                        {
                          ...
                          (order.order_status_stage ===
                            ...
                            order.order_status_stage ===
                              EnumOrderStatusStage.PAYMENT_SUCCESS) &&
                          !order.shipperDetails ? (
                            <Tooltip title="Chỉ định Người giao hàng">
                              <IconButton
                                onClick={() =>
                                  handleOpenAssignShipperPopup({
      ...
      /> */}
      {/* // ============================================================================= */}
      <ModalShipperListForAssign
        openAssignShipperPopup={openAssignShipperPopup}
        handleCloseAssignShipperPopup={handleCloseAssignShipperPopup}
