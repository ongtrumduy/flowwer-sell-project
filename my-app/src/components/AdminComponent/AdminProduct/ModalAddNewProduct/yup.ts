...
const productAddNewSchema = Yup.object().shape({
  ...
  product_image: Yup.mixed<File>()
    .nullable() // Chấp nhận `null` làm giá trị hợp lệ
    .required('Ảnh sản phẩm là bắt buộc.') // Bắt buộc không được bỏ trống
...
export default productAddNewSchema;
