...
const AdminPaginationCategoryList = ({ totalPages, onPageChange }: { totalPages: number; onPageChange: ({ page }: { page: number }) => void }) => {
...
export default AdminPaginationCategoryList;
